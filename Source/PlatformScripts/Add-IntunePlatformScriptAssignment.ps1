# Write the comment-based HELP for Add-IntunePlatformScriptAssignment
<#
.SYNOPSIS
    Adds an Intune platform script assignment.

.DESCRIPTION
    Adds an Intune platform script assignment.

.PARAMETER Id
    The id of the platform script to assign.

.PARAMETER GroupId
    The id of the group to assign the platform script to.

.PARAMETER IncludeExcludeGroup
    The type of group assignment. Valid values are include, exclude.

.PARAMETER FilterId
    The id of the filter to assign the platform script to.

.PARAMETER FilterType
    The type of filter assignment. Valid values are include, exclude.

.PARAMETER AssignmentObject
    The assignment object to add. Use New-IntunePlatformScriptAssignment to create the object.

.PARAMETER Environment
    The environment to connect to. Valid values are Global, USGov, USGovDoD. Default is Global.

.EXAMPLE
    # Add a platform script assignment.
    Add-IntunePlatformScriptAssignment -Id "00000000-0000-0000-0000-000000000000" -GroupId "00000000-0000-0000-0000-000000000000" -IncludeExcludeGroup "include"

.EXAMPLE
    # Add a platform script assignment with a filter.
    Add-IntunePlatformScriptAssignment -Id "00000000-0000-0000-0000-000000000000" -GroupId "00000000-0000-0000-0000-000000000000" -IncludeExcludeGroup "include" -FilterId "00000000-0000-0000-0000-000000000000" -FilterType "include"

.EXAMPLE
    # Add a platform script assignment with an assignment object.
    $assignment = New-IntunePlatformScriptAssignment -GroupId "00000000-0000-0000-0000-000000000000" -IncludeExcludeGroup "include"
    Add-IntunePlatformScriptAssignment -Id "00000000-0000-0000-0000-000000000000" -AssignmentObject $assignment

.EXAMPLE
    # Add a platform script assignment with an assignment object in the USGov environment.
    $assignment = New-IntunePlatformScriptAssignment -GroupId "00000000-0000-0000-0000-000000000000" -IncludeExcludeGroup "include"
    Add-IntunePlatformScriptAssignment -Id "00000000-0000-0000-0000-000000000000" -AssignmentObject $assignment -Environment USGov

.EXAMPLE
    # Add a platform script assignment with a filter in the USGov environment.
    Add-IntunePlatformScriptAssignment -Id "00000000-0000-0000-0000-000000000000" -GroupId "00000000-0000-0000-0000-000000000000" -IncludeExcludeGroup "include" -FilterId "00000000-0000-0000-0000-000000000000" -FilterType "include" -Environment USGov
...
.EXAMPLE
    ...
    Add-IntunePlatformScriptAssignment -Id "00000000-0000-0000-0000-000000000000" -GroupId "00000000-0000-0000-0000-000000000000" -IncludeExcludeGroup "include" -FilterId "00000000-0000-0000-0000-000000000000" -FilterType "include" -Environment USGov
#>
function Add-IntunePlatformScriptAssignment
{
    param (     
        [Parameter(Mandatory, ParameterSetName="Group", Position=0, HelpMessage="platform script Id")]
        [Parameter(Mandatory, ParameterSetName="GroupAndFilter", Position=0, HelpMessage="platform script Id")]
    ...
    process 
    {
        [array]$assignments = Get-IntunePlatformScriptAssignments -Id $Id -Environment $Environment
